...
class GoodCategory(models.Model):
    ...
    parent_category = models.ForeignKey("self",on_delete=models.CASCADE,null=True,blank=True,
                                        verbose_name='父类目',related_name='sub_cat')
...
class Goods(models.Model):
    ...
    fav_num = models.IntegerField("收藏数量",default=0)
...
class GoodsCategoryBrand(models.Model):
    ...
    某一大类下的宣传商标
    """
    category = models.ForeignKey(GoodCategory, on_delete=models.CASCADE, related_name='brands', null=True, blank=True, verbose_name="商品类目")
...
class IndexAd(models.Model):
    ...
    商品广告
    """
    category = models.ForeignKey(GoodCategory, on_delete=models.CASCADE, related_name='category',verbose_name="商品类目")
